...
WASI process-associated clocks; to enable emulation of the `getrusage` function using \
...
#define RLIMIT_AS      0
#endif
#define RLIMIT_LOCKS   0
#define RLIMIT_SIGPENDING 0
#define RLIMIT_MSGQUEUE 0
#define RLIMIT_NICE    0
#define RLIMIT_RTPRIO  0
#define RLIMIT_RTTIME  0
#define RLIMIT_NLIMITS 0
